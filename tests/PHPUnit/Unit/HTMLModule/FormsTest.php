...
<form action="http://somesite.com/prog/component-select" method="post">
   ...
   <input type="submit" value="Send" /><input type="reset" />
     ...
     * @test
     */
    public function testSelectOptgroup(): void
    {
        $this->config->set('HTML.Doctype', 'HTML 4.01 Strict');
        $this->assertResult('
...
<form action="..." method="post">
 ...
 <fieldset>
  ...
  <textarea name="current_medication" rows="20" cols="50" tabindex="40"></textarea>
     ...
     * @test
     */
    public function testInputTransform(): void
    {
     ...
     * @test
     */
    public function testTextareaTransform(): void
    {
        $this->config->set('HTML.Doctype', 'HTML 4.01 Strict');
     ...
     * @test
     */
    public function testTextInFieldset(): void
    {
        $this->config->set('HTML.Doctype', 'HTML 4.01 Strict');
