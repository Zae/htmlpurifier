...
class Validator
{
     ...
     * @throws Exception
     */
    public function validate(Interchange $interchange): bool
    {
     ...
     * @throws Exception
     */
    public function validateId(Id $id): void
    {
    ...
    public function validateDirective(Directive $d): void
    {
        ...
        if (!empty($d->valueAliases) || !is_null($d->allowed)) {
     ...
     * @throws Exception
     */
    public function validateDirectiveAllowed(Directive $d): void
    {
     ...
     * @throws Exception
     */
    public function validateDirectiveValueAliases(Directive $d): void
    {
     ...
     * @throws Exception
     */
    public function validateDirectiveAliases(Directive $d): void
    {
        $this->with($d, 'aliases')
             ->assertIsArray(); // handled by InterchangeBuilder
     ...
     */
    protected function with($obj, string $member): ValidatorAtom
    {
        return new ValidatorAtom($this->getFormattedContext(), $obj, $member);
    }
